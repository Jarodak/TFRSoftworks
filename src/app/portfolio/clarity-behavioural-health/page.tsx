...
export default function ClarityBehaviouralHealthPage() {
  return (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div>
                <div className="bg-white p-8 rounded-2xl ring-1 ring-white/10 backdrop-blur-sm mb-6">
                  <Image
                    src="/Clarity.png"
                    alt="Clarity Behavioural Health"
                    width={480}
                    height={180}
                    priority
              ...
              <div>
                ...
                <p className="text-xl text-white/70 mb-8">
                  Personalized treatment and relaxation content for in-patient behavioral health centers, improving patient engagement and outcomes.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">
                        Enhancing behavioral health treatment through personalized, evidence-based content delivery and patient engagement tools.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">
                        Improving patient engagement and treatment outcomes in behavioral health facilities through tailored therapeutic content.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">
                        Kernel Equity provided healthcare technology expertise and content management platform development for behavioral health settings.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-slate-950/35 p-6 rounded-2xl ring-1 ring-white/10 backdrop-blur-sm">
                ...
                <ul className="space-y-3 text-white/70">
                  <li>• Personalized content delivery system</li>
                  <li>• Evidence-based therapeutic materials</li>
                  <li>• Patient progress tracking and analytics</li>
                  <li>• Provider dashboard and reporting</li>
                  <li>• Multi-modal content (video, audio, interactive)</li>
                </ul>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <p className="text-white/70 text-sm">
                    Built comprehensive content management and delivery platform tailored for behavioral health environments.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-white mb-2">Clinical Workflow</h4>
                  <p className="text-white/70 text-sm">
                    Developed workflows that integrate seamlessly with existing behavioral health treatment protocols and staff workflows.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-white mb-2">Compliance & Security</h4>
                  <p className="text-white/70 text-sm">
                    Created evidence-based content curation and personalization algorithms to optimize patient engagement and outcomes.
                  </p>
                </div>
              </div>
            </div>
