...
export default function ClearlyLegalPage() {
  return (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div>
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-white/70">LegalTech / SaaS</span>
                </div>

                <a
                  href="https://clearly.legal"
                  target="_blank"
              ...
              <div>
                ...
                <p className="text-xl text-white/70 mb-8">
                  CLE-by-podcast microlearning platform with automatic credit tracking and reporting for legal professionals.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">
                        Revolutionizing legal education through accessible, podcast-based continuing education with seamless credit management.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">
                        Enabling legal professionals to fulfill CLE requirements efficiently while staying current with industry developments.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">
                        Kernel Equity provided legal technology expertise and platform development for innovative CLE delivery solutions.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-slate-950/35 p-6 rounded-2xl ring-1 ring-white/10 backdrop-blur-sm">
                ...
                <ul className="space-y-3 text-white/70">
                  <li>• Podcast-based CLE content delivery</li>
                  <li>• Automatic credit tracking and reporting</li>
                  <li>• State bar compliance management</li>
                  <li>• Microlearning and bite-sized modules</li>
              ...
              <div className="bg-slate-950/35 p-6 rounded-2xl ring-1 ring-white/10 backdrop-blur-sm">
                ...
                <ul className="space-y-3 text-white/70">
                  ...
                  <li>• Podcast streaming and analytics</li>
                  <li>• Node.js & Express backend</li>
                  <li>• PostgreSQL database</li>
                  <li>• Legal compliance integrations</li>
                </ul>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <p className="text-white/70 text-sm">
                    Built innovative CLE delivery platform with focus on podcast integration and automated compliance tracking.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-white mb-2">Market Strategy</h4>
                  <p className="text-white/70 text-sm">
                    Developed go-to-market strategies and partnership frameworks for legal education market expansion.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-white mb-2">Legal Workflow</h4>
                  <p className="text-white/70 text-sm">
                    Developed content curation and delivery frameworks for engaging, educational legal programming.
                  </p>
                </div>
              </div>
            </div>
