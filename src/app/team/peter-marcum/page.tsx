...
export default function PeterMarcum() {
  return (
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start mb-12">
              <div className="relative w-48 h-48 rounded-full overflow-hidden ring-4 ring-white/20 flex-shrink-0 mx-auto md:mx-0">
                <Image
                  src="/Peter Marcum.jpg"
                  alt="Peter Marcum headshot"
                  fill
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-2xl text-[color:var(--sage-400)] font-medium mb-4">Founding Partner</p>
                <a 
                  href="https://www.linkedin.com/in/petermarcum/" 
                  target="_blank" 
